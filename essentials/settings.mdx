...
<ResponseField name="Permission Fields We Take" type="Navigation[]" required>
  ...
  <Expandable title="Permission Fields We Take">
    ...
    Actions For Repository (Workflows, Workflow Runs & Artifacts)
    ...
    <ResponseField name="Codespace Lifecycle Admin" type="string[]">
    Manage lifecycle of codespaces
    Access: `Read-only`
   ...
   View Deployments and Deployment Statuses
    Access: `Read-only`
